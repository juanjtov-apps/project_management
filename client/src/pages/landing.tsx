            ...
            <div className="relative bg-white rounded-xl shadow-2xl border border-slate-200/50 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-lg font-semibold text-slate-800">Task Management Dashboard</h3>
                  <div className="text-sm text-slate-500">Downtown Office Complex Project</div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium text-sm text-slate-800">Foundation Pour - East Wing</div>
                        <div className="text-xs text-slate-500">Assigned to: Mike Johnson • Due: Yesterday</div>
                      </div>
                    </div>
                    <div className="text-xs bg-red-100 text-red-600 px-2 py-1 rounded">OVERDUE</div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium text-sm text-slate-800">Electrical Rough-In Inspection</div>
                        <div className="text-xs text-slate-500">Assigned to: Sarah Chen • Due: Today 3:00 PM</div>
                      </div>
                    </div>
                    <div className="text-xs bg-orange-100 text-orange-600 px-2 py-1 rounded">TODAY</div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium text-sm text-slate-800">HVAC System Installation</div>
                        <div className="text-xs text-slate-500">Assigned to: Team Alpha • Due: Tomorrow</div>
                      </div>
                    </div>
                    <div className="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded">PROGRESS</div>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg border">
                    <div className="flex items-center">
                      ...
                      <div>
                        <div className="font-medium text-sm text-slate-800">Safety Inspection - Level 2</div>
                        <div className="text-xs text-slate-500">Completed by: David Rodriguez • 2 hours ago</div>
                      </div>
                    </div>
                    <div className="text-xs bg-green-100 text-green-600 px-2 py-1 rounded">DONE</div>
                  </div>
                </div>
                
                {/* Quick Actions */}
                <div className="mt-6 flex space-x-3">
                  <button className="bg-[var(--proesphere-teal)] text-white text-xs px-3 py-2 rounded-lg font-medium">+ Add Task</button>
                  <button className="bg-slate-200 text-slate-600 text-xs px-3 py-2 rounded-lg font-medium">View Calendar</button>
                  <button className="bg-slate-200 text-slate-600 text-xs px-3 py-2 rounded-lg font-medium">Generate Report</button>
                </div>
              </div>
            </div>
          </div>
