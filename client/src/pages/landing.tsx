              ...
              <div className="p-8">
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="bg-slate-100 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-[var(--proesphere-deep-blue)]">12</div>
                    <div className="text-sm text-slate-500">Active Projects</div>
                  </div>
                  <div className="bg-slate-100 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-[var(--proesphere-deep-blue)]">7</div>
                    <div className="text-sm text-slate-500">Tasks Due Today</div>
                  </div>
                  <div className="bg-slate-100 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-[var(--proesphere-deep-blue)]">156</div>
                ...
                <div className="bg-slate-50 rounded-lg p-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center text-sm text-slate-600">
                      <div className="w-2 h-2 bg-[var(--proesphere-teal)] rounded-full mr-2"></div>
