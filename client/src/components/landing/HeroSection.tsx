  ...
  return (
    <section className="landing-hero landing-section">
      ...
      <div className="hero-top-text" style={{ animation: 'heroFadeIn 0.7s ease-out 0.1s forwards', opacity: 0 }}>
        <div className="hero-eyebrow"><b />{t('hero.eyebrow')}<b /></div>
        <h1 className="hero-h1"><Trans i18nKey="hero.headline" ns="landing" components={{ em: <em /> }} /></h1>
        ...
        <div className="hero-ctas">
          ...
          <button className="btn-hero-ghost" onClick={onGetStarted}>{t('hero.ctaSecondary')}</button>
        </div>
      </div>
